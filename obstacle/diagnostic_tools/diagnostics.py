from Poisson2D_diagnostic import poisson2d
...
from ReducedSpace_diagnostic import rspmethod_lcp_solver
from projected_newton_diagnostic import PNmethod_lcp_solver
...
def radialproblem_pfas_diagnostic(cycle, coarse_mx = 1, coarse_my = 1, min_num_levels = 6, max_num_levels = None,
    ...
    for i in range(min_num_levels, max_num_levels, step):
        ...
        print('total smoothing times: ' + str(sum(pfas_solver.smoothing_times)))
        print('total transfer times: ' + str(sum(pfas_solver.transfer_times)))
