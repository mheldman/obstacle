...
def main(argv):
  ...
  try:
   opts, args = getopt.getopt(argv,"hi:o:",["ofile=", "show_residuals=", "show_active_set=", "num_grids=", "coarse_mx=", "coarse_my=", "maxiters=", "ksp_type=", "pc_type=", "tol=", "plot_solution=", "solver_type=", "cycle_type=", "pfas_accel=", "problem_data=", "res_heat_map=", "smoothing_iters="])
  ...
  if solver_type == 'pfas' or solver_type == 'mlrsp': #add grid sequenced version
    ...
    if pfas_accel == True:
      ...
      rsp_solver = rspmethod_lcp_solver(obstacle_problem.A, obstacle_problem.F, tol, maxiters, diagnostics=diagnostics)
